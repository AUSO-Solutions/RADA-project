...
const Homepage = () => {
  ...
  //       <img src={img} alt='' />
  //       <button style={{
  //         position: 'absolute', top: '66.4%', borderRadius: '5px', backgroundColor: color, color: 'white', height: '100px', width: '321px', fontSize: '23px', boxShadow: '0px 8px 25px 0px #BDDEF3',
  //       }} >{text}</button>
  //     </div>
  //   )
